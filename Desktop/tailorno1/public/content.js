...
function dynamicClothingSection(ob) {
  ...
  let buttonText = document.createTextNode("Add to card");
  addCard.appendChild(buttonText);
...
httpRequest.open(
  "GET",
  "https://67c34dfd1851890165aeba79.mockapi.io/movapi/Product",
  true
);
httpRequest.send();
